...
/**
 * @file
 * @brief Generated from player_passive_skill_table.xsd.
 */

#ifndef GDT_PLAYER_PASSIVE_SKILL_TABLE_HXX
#define GDT_PLAYER_PASSIVE_SKILL_TABLE_HXX
...
namespace gdt
{
  ...
  class player_passive_skill_table;
}
...
{
  /**
   * @brief Class corresponding to the %player_passive_skill_t schema type.
   *
   * @nosubgrouping
   */
  class GIDEON_CS_API player_passive_skill_t: public ::xml_schema::type
  {
    public:
    /**
     * @name skill_code
     ...
     */
    player_passive_skill_t (const skill_code_type&,
                            const effect_level_type&,
                            const top_threat_apply_value_type&,
                            const need_skill_point_type&,
                            const learn_character_class_type&,
     ...
     */
    virtual player_passive_skill_t*
  ...
  /**
   * @brief Class corresponding to the %player_passive_skill_table schema type.
   *
   * @nosubgrouping
   */
  class GIDEON_CS_API player_passive_skill_table: public ::xml_schema::type
  {
    public:
    /**
     * @name player_passive_skill_template
     *
     * @brief Accessor and modifier functions for the %player_passive_skill_template
     * sequence element.
     */
    //@{
     ...
     * @brief Element type.
     */
    typedef ::gdt::player_passive_skill_t player_passive_skill_template_type;

    /**
     * @brief Element sequence container type.
     */
    typedef ::xsd::cxx::tree::sequence< player_passive_skill_template_type > player_passive_skill_template_sequence;

    /**
     * @brief Element iterator type.
     */
    typedef player_passive_skill_template_sequence::iterator player_passive_skill_template_iterator;

    /**
     * @brief Element constant iterator type.
     */
    typedef player_passive_skill_template_sequence::const_iterator player_passive_skill_template_const_iterator;

    /**
     * @brief Element traits type.
     */
    typedef ::xsd::cxx::tree::traits< player_passive_skill_template_type, wchar_t > player_passive_skill_template_traits;
     ...
     */
    const player_passive_skill_template_sequence&
     ...
     */
    player_passive_skill_template_sequence&
     ...
     * models instead of the copy constructor.
     */
    virtual player_passive_skill_table*
    _clone (::xml_schema::flags f = 0,
            ::xml_schema::container* c = 0) const;
    ...
    protected:
    player_passive_skill_template_sequence player_passive_skill_template_;
...
{
  /**
   * @name Parsing functions for the %player_passive_skill_table document root.
   */
  //@{
  ...
  player_passive_skill_table_ (const ::std::wstring& uri,
                               ::xml_schema::flags f = 0,
  ...
  GIDEON_CS_API
  ::std::unique_ptr< ::gdt::player_passive_skill_table >
  player_passive_skill_table_ (::xercesc::InputSource& is,
                               ::xml_schema::flags f = 0,
                               const ::xml_schema::properties& p = ::xml_schema::properties ());
  ...
  GIDEON_CS_API
  ::std::unique_ptr< ::gdt::player_passive_skill_table >
  player_passive_skill_table_ (const ::xercesc::DOMDocument& d,
                               ::xml_schema::flags f = 0,
                               const ::xml_schema::properties& p = ::xml_schema::properties ());
...
{
  /**
   * @name Serialization functions for the %player_passive_skill_table document root.
   */
  //@{
  ...
  GIDEON_CS_API
  void
  player_passive_skill_table_ (::std::ostream& os,
                               const ::gdt::player_passive_skill_table& x, 
  ...
  GIDEON_CS_API
  void
  player_passive_skill_table_ (::xercesc::XMLFormatTarget& ft,
                               const ::gdt::player_passive_skill_table& x, 
                               const ::xml_schema::namespace_infomap& m = ::xml_schema::namespace_infomap (),
                               const ::std::wstring& e = L"UTF-8",
                               ::xml_schema::flags f = 0);
  ...
  player_passive_skill_table_ (const ::gdt::player_passive_skill_table& x, 
                               const ::xml_schema::namespace_infomap& m = ::xml_schema::namespace_infomap (),
                               ::xml_schema::flags f = 0);
  ...
  GIDEON_CS_API
  void
  operator<< (::xercesc::DOMElement&, const player_passive_skill_t&);

  GIDEON_CS_API
  void
  operator<< (::xercesc::DOMElement&, const player_passive_skill_table&);
}

#ifndef XSD_DONT_INCLUDE_INLINE
#include "player_passive_skill_table.ixx"
#endif // XSD_DONT_INCLUDE_INLINE
...
#endif // GDT_PLAYER_PASSIVE_SKILL_TABLE_HXX

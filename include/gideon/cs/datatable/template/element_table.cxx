...
namespace gdt
{
  ...
  element_t::
  element_t (const element_code_type& element_code,
  ...
  : ::xml_schema::type (),
    element_code_ (element_code, this),
  ...
  : ::xml_schema::type (x, f, c),
    element_code_ (x.element_code_, f, this),
         ...
         ::xml_schema::flags f)
  {
    while (p.more_attributes ())
    {
      ...
      if (n.name () == L"element_code" && n.namespace_ ().empty ())
      {
        this->element_code_.set (element_code_traits::create (i, f, this));
        continue;
      }
  ...
  {
    return new class element_t (*this, f, c);
  }
  ...
  operator= (const element_t& x)
  {
    if (this != &x)
    {
      ...
      this->element_code_ = x.element_code_;
  ...
  element_table (const element_table& x,
                 ...
                 ::xml_schema::container* c)
  : ::xml_schema::type (x, f, c),
    element_template_ (x.element_template_, f, this)
  {
  }
         ...
         ::xml_schema::flags f)
  {
    for (; p.more_content (); p.next_content (false))
    {
      ...
      // element_template
      //
      if (n.name () == L"element_template" && n.namespace_ ().empty ())
      {
        ::std::unique_ptr< element_template_type > r (
          element_template_traits::create (i, f, this));

        this->element_template_.push_back (::std::move (r));
        continue;
      }
  ...
  _clone (::xml_schema::flags f,
          ::xml_schema::container* c) const
  {
    return new class element_table (*this, f, c);
  }
  ...
  operator= (const element_table& x)
  {
    ...
    {
      static_cast< ::xml_schema::type& > (*this) = x;
      this->element_template_ = x.element_template_;
    }
...
namespace gdt
{
  ...
  element_table_ (const ::std::wstring& u,
                  ::xml_schema::flags f,
                  const ::xml_schema::properties& p)
  {
    ...
    return ::std::unique_ptr< ::gdt::element_table > (
      ::gdt::element_table_ (
                  ...
                  const ::xml_schema::properties& p)
  {
    ...
    return ::gdt::element_table_ (isrc, f, p);
  }
                  ...
                  const ::xml_schema::properties& p)
  {
    ...
    ::xsd::cxx::xml::sax::std_input_source isrc (is);
    return ::gdt::element_table_ (isrc, h, f, p);
  }
  ...
  ::std::unique_ptr< ::gdt::element_table >
  element_table_ (::xercesc::InputSource& i,
                  ::xml_schema::flags f,
                  const ::xml_schema::properties& p)
  {
    ::xsd::cxx::tree::error_handler< wchar_t > h;
  ...
  ::std::unique_ptr< ::gdt::element_table >
  element_table_ (const ::xercesc::DOMDocument& doc,
                  ::xml_schema::flags f,
                  const ::xml_schema::properties& p)
  {
    ...
    if (n.name () == L"element_table" &&
        n.namespace_ () == L"")
    {
      ::std::unique_ptr< ::gdt::element_table > r (
        ::xsd::cxx::tree::traits< ::gdt::element_table, wchar_t >::create (
          e, f, 0));
      return r;
    }
...
{
  void
  element_table_ (::std::ostream& o,
                  const ::gdt::element_table& s,
  ...
  void
  element_table_ (::xercesc::XMLFormatTarget& t,
                  const ::gdt::element_table& s,
                  const ::xml_schema::namespace_infomap& m,
                  const ::std::wstring& e,
                  ::xml_schema::flags f)
  ...
  element_table_ (const ::gdt::element_table& s,
                  const ::xml_schema::namespace_infomap& m,
                  ::xml_schema::flags f)
  {
    ::xml_schema::dom::unique_ptr< ::xercesc::DOMDocument > d (
    ...
    ::gdt::element_table_ (*d, s, f);
    return d;
  }

  void
  operator<< (::xercesc::DOMElement& e, const element_t& i)
  {
  ...
  void
  operator<< (::xercesc::DOMElement& e, const element_table& i)
  {
    e << static_cast< const ::xml_schema::type& > (i);

    // element_template
    //
    for (element_table::element_template_const_iterator
         b (i.element_template ().begin ()), n (i.element_template ().end ());
         b != n; ++b)
    {

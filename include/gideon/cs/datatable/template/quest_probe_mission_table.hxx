...
/**
 * @file
 * @brief Generated from quest_probe_mission_table.xsd.
 */

#ifndef GDT_QUEST_PROBE_MISSION_TABLE_HXX
#define GDT_QUEST_PROBE_MISSION_TABLE_HXX
...
namespace gdt
{
  class quest_probe_mission_t;
  class quest_probe_mission_table;
}
...
{
  /**
   * @brief Class corresponding to the %quest_probe_mission_t schema type.
   *
   * @nosubgrouping
   */
  class GIDEON_CS_API quest_probe_mission_t: public ::xml_schema::type
  {
    public:
    /**
     * @name mission_code
     ...
     */
    quest_probe_mission_t (const mission_code_type&,
                           const map_code_type&,
                           const marker_code_1_type&,
                           const marker_code_2_type&,
                           const marker_code_3_type&);
  ...
  /**
   * @brief Class corresponding to the %quest_probe_mission_table schema type.
   *
   * @nosubgrouping
   */
  class GIDEON_CS_API quest_probe_mission_table: public ::xml_schema::type
  {
    public:
    /**
     * @name quest_probe_mission_template
     *
     * @brief Accessor and modifier functions for the %quest_probe_mission_template
     * sequence element.
     */
    //@{
     ...
     * @brief Element type.
     */
    typedef ::gdt::quest_probe_mission_t quest_probe_mission_template_type;

    /**
     * @brief Element sequence container type.
     */
    typedef ::xsd::cxx::tree::sequence< quest_probe_mission_template_type > quest_probe_mission_template_sequence;

    /**
     * @brief Element iterator type.
     */
    typedef quest_probe_mission_template_sequence::iterator quest_probe_mission_template_iterator;

    /**
     * @brief Element constant iterator type.
     */
    typedef quest_probe_mission_template_sequence::const_iterator quest_probe_mission_template_const_iterator;

    /**
     * @brief Element traits type.
     */
    typedef ::xsd::cxx::tree::traits< quest_probe_mission_template_type, wchar_t > quest_probe_mission_template_traits;
     ...
     */
    const quest_probe_mission_template_sequence&
    quest_probe_mission_template () const;
     ...
     */
    quest_probe_mission_template_sequence&
     ...
     */
    void
    quest_probe_mission_template (const quest_probe_mission_template_sequence& s);
     ...
     * models instead of the copy constructor.
     */
    virtual quest_probe_mission_table*
    _clone (::xml_schema::flags f = 0,
            ::xml_schema::container* c = 0) const;
    ...
    protected:
    quest_probe_mission_template_sequence quest_probe_mission_template_;
...
{
  /**
   * @name Parsing functions for the %quest_probe_mission_table document root.
   */
  //@{
  ...
  quest_probe_mission_table_ (const ::std::wstring& uri,
                              ::xml_schema::flags f = 0,
  ...
  GIDEON_CS_API
  ::std::unique_ptr< ::gdt::quest_probe_mission_table >
  quest_probe_mission_table_ (::xercesc::InputSource& is,
                              ::xml_schema::flags f = 0,
                              const ::xml_schema::properties& p = ::xml_schema::properties ());
  ...
  GIDEON_CS_API
  ::std::unique_ptr< ::gdt::quest_probe_mission_table >
  quest_probe_mission_table_ (const ::xercesc::DOMDocument& d,
                              ::xml_schema::flags f = 0,
                              const ::xml_schema::properties& p = ::xml_schema::properties ());
...
{
  /**
   * @name Serialization functions for the %quest_probe_mission_table document root.
   */
  //@{
  ...
  GIDEON_CS_API
  void
  quest_probe_mission_table_ (::std::ostream& os,
                              const ::gdt::quest_probe_mission_table& x, 
  ...
  GIDEON_CS_API
  void
  quest_probe_mission_table_ (::xercesc::XMLFormatTarget& ft,
                              const ::gdt::quest_probe_mission_table& x, 
                              const ::xml_schema::namespace_infomap& m = ::xml_schema::namespace_infomap (),
                              const ::std::wstring& e = L"UTF-8",
                              ::xml_schema::flags f = 0);
  ...
  quest_probe_mission_table_ (const ::gdt::quest_probe_mission_table& x, 
                              const ::xml_schema::namespace_infomap& m = ::xml_schema::namespace_infomap (),
                              ::xml_schema::flags f = 0);
  ...
  GIDEON_CS_API
  void
  operator<< (::xercesc::DOMElement&, const quest_probe_mission_t&);

  GIDEON_CS_API
  void
  operator<< (::xercesc::DOMElement&, const quest_probe_mission_table&);
}

#ifndef XSD_DONT_INCLUDE_INLINE
#include "quest_probe_mission_table.ixx"
#endif // XSD_DONT_INCLUDE_INLINE
...
#endif // GDT_QUEST_PROBE_MISSION_TABLE_HXX

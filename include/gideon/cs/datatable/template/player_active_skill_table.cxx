...
#include "player_active_skill_table.hxx"
...
namespace gdt
{
  ...
  : ::xml_schema::type (),
    ...
    need_skill_point_ (this),
    learn_character_class_ (this),
    need_learn_skill_code_1_ (need_learn_skill_code_1_default_value (), this),
    need_learn_skill_code_2_ (need_learn_skill_code_2_default_value (), this),
    next_skill_code_1_ (next_skill_code_1_default_value (), this),
    next_skill_code_2_ (next_skill_code_2_default_value (), this),
    check_equip_part_ (this),
    check_castable_equip_type_ (this),
    skill_type_ (this),
    usable_state_ (this),
    ...
    check_point_target_type_ (this),
    check_point_type_ (this),
    check_point_up_down_ (this),
    check_point_value_by_percent_ (this),
    check_point_value_ (this),
    ...
    min_distance_ (this),
    max_distance_ (this),
    channel_casting_time_ (this),
    channel_tick_ (this),
    consume_item_code_ (this),
    consume_item_count_ (this),
    cooldown_time_ (this),
    ...
    combo_1_caster_animation_name_ (this),
    combo_1_caster_effect_ (this),
    combo_1_castee_animation_name_ (this),
    combo_1_castee_effect_ (this),
    combo_1_castee_interval_time_ (this),
    combo_2_caster_animation_name_ (this),
    combo_2_caster_effect_ (this),
    combo_2_castee_animation_name_ (this),
    combo_2_castee_effect_ (this),
    combo_2_castee_interval_time_ (this),
    combo_3_caster_animation_name_ (this),
    combo_3_caster_effect_ (this),
    combo_3_castee_animation_name_ (this),
    combo_3_castee_effect_ (this),
    combo_3_castee_interval_time_ (this)
  {
  }

  player_active_skill_t::
  player_active_skill_t (const skill_code_type& skill_code,
                         const effect_level_type& effect_level,
                         const top_threat_apply_value_type& top_threat_apply_value,
                         const need_skill_point_type& need_skill_point,
                         const learn_character_class_type& learn_character_class,
                         const check_equip_part_type& check_equip_part,
                         const check_castable_equip_type_type& check_castable_equip_type,
                         const skill_type_type& skill_type,
                         const usable_state_type& usable_state,
                         const transition_state_type& transition_state,
                         const consumed_hp_type& consumed_hp,
                         const consumed_mp_type& consumed_mp,
                         const check_mez_type_type& check_mez_type,
                         const check_point_target_type_type& check_point_target_type,
                         const check_point_type_type& check_point_type,
                         const check_point_up_down_type& check_point_up_down,
                         const check_point_value_by_percent_type& check_point_value_by_percent,
                         const check_point_value_type& check_point_value,
                         ...
                         const channel_casting_time_type& channel_casting_time,
                         const channel_tick_type& channel_tick,
                         const consume_item_code_type& consume_item_code,
                         const consume_item_count_type& consume_item_count,
                         ...
                         const combo_1_caster_animation_name_type& combo_1_caster_animation_name,
                         const combo_1_caster_effect_type& combo_1_caster_effect,
                         const combo_1_castee_animation_name_type& combo_1_castee_animation_name,
                         const combo_1_castee_effect_type& combo_1_castee_effect,
                         const combo_1_castee_interval_time_type& combo_1_castee_interval_time,
                         const combo_2_caster_animation_name_type& combo_2_caster_animation_name,
                         const combo_2_caster_effect_type& combo_2_caster_effect,
                         const combo_2_castee_animation_name_type& combo_2_castee_animation_name,
                         const combo_2_castee_effect_type& combo_2_castee_effect,
                         const combo_2_castee_interval_time_type& combo_2_castee_interval_time,
                         const combo_3_caster_animation_name_type& combo_3_caster_animation_name,
                         const combo_3_caster_effect_type& combo_3_caster_effect,
                         const combo_3_castee_animation_name_type& combo_3_castee_animation_name,
                         const combo_3_castee_effect_type& combo_3_castee_effect,
                         const combo_3_castee_interval_time_type& combo_3_castee_interval_time)
  : ::xml_schema::type (),
    skill_code_ (skill_code, this),
    effect_level_ (effect_level, this),
    top_threat_apply_value_ (top_threat_apply_value, this),
    need_skill_point_ (need_skill_point, this),
    learn_character_class_ (learn_character_class, this),
    need_learn_skill_code_1_ (need_learn_skill_code_1_default_value (), this),
    need_learn_skill_code_2_ (need_learn_skill_code_2_default_value (), this),
    next_skill_code_1_ (next_skill_code_1_default_value (), this),
    next_skill_code_2_ (next_skill_code_2_default_value (), this),
    check_equip_part_ (check_equip_part, this),
    check_castable_equip_type_ (check_castable_equip_type, this),
    skill_type_ (skill_type, this),
    usable_state_ (usable_state, this),
    transition_state_ (transition_state, this),
    consumed_hp_ (consumed_hp, this),
    consumed_mp_ (consumed_mp, this),
    check_mez_type_ (check_mez_type, this),
    check_point_target_type_ (check_point_target_type, this),
    check_point_type_ (check_point_type, this),
    check_point_up_down_ (check_point_up_down, this),
    check_point_value_by_percent_ (check_point_value_by_percent, this),
    check_point_value_ (check_point_value, this),
    ...
    channel_casting_time_ (channel_casting_time, this),
    channel_tick_ (channel_tick, this),
    consume_item_code_ (consume_item_code, this),
    consume_item_count_ (consume_item_count, this),
    ...
    combo_1_caster_animation_name_ (combo_1_caster_animation_name, this),
    combo_1_caster_effect_ (combo_1_caster_effect, this),
    combo_1_castee_animation_name_ (combo_1_castee_animation_name, this),
    combo_1_castee_effect_ (combo_1_castee_effect, this),
    combo_1_castee_interval_time_ (combo_1_castee_interval_time, this),
    combo_2_caster_animation_name_ (combo_2_caster_animation_name, this),
    combo_2_caster_effect_ (combo_2_caster_effect, this),
    combo_2_castee_animation_name_ (combo_2_castee_animation_name, this),
    combo_2_castee_effect_ (combo_2_castee_effect, this),
    combo_2_castee_interval_time_ (combo_2_castee_interval_time, this),
    combo_3_caster_animation_name_ (combo_3_caster_animation_name, this),
    combo_3_caster_effect_ (combo_3_caster_effect, this),
    combo_3_castee_animation_name_ (combo_3_castee_animation_name, this),
    combo_3_castee_effect_ (combo_3_castee_effect, this),
    combo_3_castee_interval_time_ (combo_3_castee_interval_time, this)
  {
  }
  ...
  : ::xml_schema::type (x, f, c),
    ...
    need_skill_point_ (x.need_skill_point_, f, this),
    learn_character_class_ (x.learn_character_class_, f, this),
    need_learn_skill_code_1_ (x.need_learn_skill_code_1_, f, this),
    need_learn_skill_code_2_ (x.need_learn_skill_code_2_, f, this),
    next_skill_code_1_ (x.next_skill_code_1_, f, this),
    next_skill_code_2_ (x.next_skill_code_2_, f, this),
    check_equip_part_ (x.check_equip_part_, f, this),
    check_castable_equip_type_ (x.check_castable_equip_type_, f, this),
    skill_type_ (x.skill_type_, f, this),
    usable_state_ (x.usable_state_, f, this),
    transition_state_ (x.transition_state_, f, this),
    consumed_hp_ (x.consumed_hp_, f, this),
    consumed_mp_ (x.consumed_mp_, f, this),
    check_mez_type_ (x.check_mez_type_, f, this),
    check_point_target_type_ (x.check_point_target_type_, f, this),
    check_point_type_ (x.check_point_type_, f, this),
    check_point_up_down_ (x.check_point_up_down_, f, this),
    check_point_value_by_percent_ (x.check_point_value_by_percent_, f, this),
    check_point_value_ (x.check_point_value_, f, this),
    ...
    channel_casting_time_ (x.channel_casting_time_, f, this),
    channel_tick_ (x.channel_tick_, f, this),
    consume_item_code_ (x.consume_item_code_, f, this),
    consume_item_count_ (x.consume_item_count_, f, this),
    ...
    combo_1_caster_animation_name_ (x.combo_1_caster_animation_name_, f, this),
    combo_1_caster_effect_ (x.combo_1_caster_effect_, f, this),
    combo_1_castee_animation_name_ (x.combo_1_castee_animation_name_, f, this),
    combo_1_castee_effect_ (x.combo_1_castee_effect_, f, this),
    combo_1_castee_interval_time_ (x.combo_1_castee_interval_time_, f, this),
    combo_2_caster_animation_name_ (x.combo_2_caster_animation_name_, f, this),
    combo_2_caster_effect_ (x.combo_2_caster_effect_, f, this),
    combo_2_castee_animation_name_ (x.combo_2_castee_animation_name_, f, this),
    combo_2_castee_effect_ (x.combo_2_castee_effect_, f, this),
    combo_2_castee_interval_time_ (x.combo_2_castee_interval_time_, f, this),
    combo_3_caster_animation_name_ (x.combo_3_caster_animation_name_, f, this),
    combo_3_caster_effect_ (x.combo_3_caster_effect_, f, this),
    combo_3_castee_animation_name_ (x.combo_3_castee_animation_name_, f, this),
    combo_3_castee_effect_ (x.combo_3_castee_effect_, f, this),
    combo_3_castee_interval_time_ (x.combo_3_castee_interval_time_, f, this)
  {
  }
  ...
  : ::xml_schema::type (e, f | ::xml_schema::flags::base, c),
    ...
    need_skill_point_ (this),
    learn_character_class_ (this),
    need_learn_skill_code_1_ (this),
    need_learn_skill_code_2_ (this),
    next_skill_code_1_ (this),
    next_skill_code_2_ (this),
    check_equip_part_ (this),
    check_castable_equip_type_ (this),
    skill_type_ (this),
    usable_state_ (this),
         ...
         ::xml_schema::flags f)
  {
    while (p.more_attributes ())
    {
      ...
      if (n.name () == L"need_skill_point" && n.namespace_ ().empty ())
      {
        this->need_skill_point_.set (need_skill_point_traits::create (i, f, this));
        continue;
      }

      if (n.name () == L"learn_character_class" && n.namespace_ ().empty ())
      {
        this->learn_character_class_.set (learn_character_class_traits::create (i, f, this));
        continue;
      }

      if (n.name () == L"need_learn_skill_code_1" && n.namespace_ ().empty ())
      {
        this->need_learn_skill_code_1_.set (need_learn_skill_code_1_traits::create (i, f, this));
        continue;
      }

      if (n.name () == L"need_learn_skill_code_2" && n.namespace_ ().empty ())
      {
        this->need_learn_skill_code_2_.set (need_learn_skill_code_2_traits::create (i, f, this));
        continue;
      }

      if (n.name () == L"next_skill_code_1" && n.namespace_ ().empty ())
      {
        this->next_skill_code_1_.set (next_skill_code_1_traits::create (i, f, this));
        continue;
      }

      if (n.name () == L"next_skill_code_2" && n.namespace_ ().empty ())
      {
        this->next_skill_code_2_.set (next_skill_code_2_traits::create (i, f, this));
        continue;
      }

      if (n.name () == L"check_equip_part" && n.namespace_ ().empty ())
      {
        this->check_equip_part_.set (check_equip_part_traits::create (i, f, this));
        continue;
      }

      if (n.name () == L"check_castable_equip_type" && n.namespace_ ().empty ())
      {
        this->check_castable_equip_type_.set (check_castable_equip_type_traits::create (i, f, this));
        continue;
      }
      ...
      if (n.name () == L"consumed_hp" && n.namespace_ ().empty ())
      {
        this->consumed_hp_.set (consumed_hp_traits::create (i, f, this));
        continue;
      }

      if (n.name () == L"consumed_mp" && n.namespace_ ().empty ())
      {
        this->consumed_mp_.set (consumed_mp_traits::create (i, f, this));
        continue;
      }
      ...
      if (n.name () == L"check_point_target_type" && n.namespace_ ().empty ())
      {
        this->check_point_target_type_.set (check_point_target_type_traits::create (i, f, this));
        continue;
      }

      if (n.name () == L"check_point_type" && n.namespace_ ().empty ())
      {
        this->check_point_type_.set (check_point_type_traits::create (i, f, this));
        continue;
      }

      if (n.name () == L"check_point_up_down" && n.namespace_ ().empty ())
      {
        this->check_point_up_down_.set (check_point_up_down_traits::create (i, f, this));
        continue;
      }

      if (n.name () == L"check_point_value_by_percent" && n.namespace_ ().empty ())
      {
        this->check_point_value_by_percent_.set (check_point_value_by_percent_traits::create (i, f, this));
        continue;
      }

      if (n.name () == L"check_point_value" && n.namespace_ ().empty ())
      {
        this->check_point_value_.set (check_point_value_traits::create (i, f, this));
        continue;
      }
      ...
      if (n.name () == L"channel_casting_time" && n.namespace_ ().empty ())
      {
        this->channel_casting_time_.set (channel_casting_time_traits::create (i, f, this));
        continue;
      }

      if (n.name () == L"channel_tick" && n.namespace_ ().empty ())
      {
        this->channel_tick_.set (channel_tick_traits::create (i, f, this));
        continue;
      }

      if (n.name () == L"consume_item_code" && n.namespace_ ().empty ())
      {
        this->consume_item_code_.set (consume_item_code_traits::create (i, f, this));
        continue;
      }

      if (n.name () == L"consume_item_count" && n.namespace_ ().empty ())
      {
        this->consume_item_count_.set (consume_item_count_traits::create (i, f, this));
        continue;
      }
      ...
      if (n.name () == L"combo_1_caster_animation_name" && n.namespace_ ().empty ())
      {
        this->combo_1_caster_animation_name_.set (combo_1_caster_animation_name_traits::create (i, f, this));
        continue;
      }

      if (n.name () == L"combo_1_caster_effect" && n.namespace_ ().empty ())
      {
        this->combo_1_caster_effect_.set (combo_1_caster_effect_traits::create (i, f, this));
        continue;
      }

      if (n.name () == L"combo_1_castee_animation_name" && n.namespace_ ().empty ())
      {
        this->combo_1_castee_animation_name_.set (combo_1_castee_animation_name_traits::create (i, f, this));
        continue;
      }

      if (n.name () == L"combo_1_castee_effect" && n.namespace_ ().empty ())
      {
        this->combo_1_castee_effect_.set (combo_1_castee_effect_traits::create (i, f, this));
        continue;
      }

      if (n.name () == L"combo_1_castee_interval_time" && n.namespace_ ().empty ())
      {
        this->combo_1_castee_interval_time_.set (combo_1_castee_interval_time_traits::create (i, f, this));
        continue;
      }

      if (n.name () == L"combo_2_caster_animation_name" && n.namespace_ ().empty ())
      {
        this->combo_2_caster_animation_name_.set (combo_2_caster_animation_name_traits::create (i, f, this));
        continue;
      }

      if (n.name () == L"combo_2_caster_effect" && n.namespace_ ().empty ())
      {
        this->combo_2_caster_effect_.set (combo_2_caster_effect_traits::create (i, f, this));
        continue;
      }

      if (n.name () == L"combo_2_castee_animation_name" && n.namespace_ ().empty ())
      {
        this->combo_2_castee_animation_name_.set (combo_2_castee_animation_name_traits::create (i, f, this));
        continue;
      }

      if (n.name () == L"combo_2_castee_effect" && n.namespace_ ().empty ())
      {
        this->combo_2_castee_effect_.set (combo_2_castee_effect_traits::create (i, f, this));
        continue;
      }

      if (n.name () == L"combo_2_castee_interval_time" && n.namespace_ ().empty ())
      {
        this->combo_2_castee_interval_time_.set (combo_2_castee_interval_time_traits::create (i, f, this));
        continue;
      }

      if (n.name () == L"combo_3_caster_animation_name" && n.namespace_ ().empty ())
      {
        this->combo_3_caster_animation_name_.set (combo_3_caster_animation_name_traits::create (i, f, this));
        continue;
      }

      if (n.name () == L"combo_3_caster_effect" && n.namespace_ ().empty ())
      {
        this->combo_3_caster_effect_.set (combo_3_caster_effect_traits::create (i, f, this));
        continue;
      }

      if (n.name () == L"combo_3_castee_animation_name" && n.namespace_ ().empty ())
      {
        this->combo_3_castee_animation_name_.set (combo_3_castee_animation_name_traits::create (i, f, this));
        continue;
      }

      if (n.name () == L"combo_3_castee_effect" && n.namespace_ ().empty ())
      {
        this->combo_3_castee_effect_.set (combo_3_castee_effect_traits::create (i, f, this));
        continue;
      }

      if (n.name () == L"combo_3_castee_interval_time" && n.namespace_ ().empty ())
      {
        this->combo_3_castee_interval_time_.set (combo_3_castee_interval_time_traits::create (i, f, this));
        continue;
      }
    }
    ...
    if (!learn_character_class_.present ())
    {
      throw ::xsd::cxx::tree::expected_attribute< wchar_t > (
        L"learn_character_class",
        L"");
    }

    if (!need_learn_skill_code_1_.present ())
    {
      this->need_learn_skill_code_1_.set (need_learn_skill_code_1_default_value ());
    }

    if (!need_learn_skill_code_2_.present ())
    {
      this->need_learn_skill_code_2_.set (need_learn_skill_code_2_default_value ());
    }

    if (!next_skill_code_1_.present ())
    {
      this->next_skill_code_1_.set (next_skill_code_1_default_value ());
    }

    if (!next_skill_code_2_.present ())
    {
      this->next_skill_code_2_.set (next_skill_code_2_default_value ());
    }

    if (!check_equip_part_.present ())
    {
      throw ::xsd::cxx::tree::expected_attribute< wchar_t > (
        L"check_equip_part",
        L"");
    ...
    if (!check_castable_equip_type_.present ())
    {
      throw ::xsd::cxx::tree::expected_attribute< wchar_t > (
        L"check_castable_equip_type",
        L"");
    }
    ...
    if (!check_point_target_type_.present ())
    {
      throw ::xsd::cxx::tree::expected_attribute< wchar_t > (
        L"check_point_target_type",
        L"");
    }

    if (!check_point_type_.present ())
    {
      throw ::xsd::cxx::tree::expected_attribute< wchar_t > (
        L"check_point_type",
        L"");
    ...
    if (!check_point_up_down_.present ())
    {
      throw ::xsd::cxx::tree::expected_attribute< wchar_t > (
        L"check_point_up_down",
        L"");
    }

    if (!check_point_value_by_percent_.present ())
    {
      throw ::xsd::cxx::tree::expected_attribute< wchar_t > (
        L"check_point_value_by_percent",
        L"");
    }

    if (!check_point_value_.present ())
    {
      throw ::xsd::cxx::tree::expected_attribute< wchar_t > (
        L"check_point_value",
        L"");
    ...
    if (!channel_casting_time_.present ())
    {
      throw ::xsd::cxx::tree::expected_attribute< wchar_t > (
        L"channel_casting_time",
        L"");
    }

    if (!channel_tick_.present ())
    {
      throw ::xsd::cxx::tree::expected_attribute< wchar_t > (
        L"channel_tick",
        L"");
    ...
    if (!consume_item_count_.present ())
    {
      throw ::xsd::cxx::tree::expected_attribute< wchar_t > (
        L"consume_item_count",
        L"");
    }
    ...
    if (!combo_1_caster_animation_name_.present ())
    {
      throw ::xsd::cxx::tree::expected_attribute< wchar_t > (
        L"combo_1_caster_animation_name",
        L"");
    }

    if (!combo_1_caster_effect_.present ())
    {
      throw ::xsd::cxx::tree::expected_attribute< wchar_t > (
        L"combo_1_caster_effect",
        L"");
    }

    if (!combo_1_castee_animation_name_.present ())
    {
      throw ::xsd::cxx::tree::expected_attribute< wchar_t > (
        L"combo_1_castee_animation_name",
        L"");
    }

    if (!combo_1_castee_effect_.present ())
    {
      throw ::xsd::cxx::tree::expected_attribute< wchar_t > (
        L"combo_1_castee_effect",
        L"");
    }

    if (!combo_1_castee_interval_time_.present ())
    {
      throw ::xsd::cxx::tree::expected_attribute< wchar_t > (
        L"combo_1_castee_interval_time",
        L"");
    }

    if (!combo_2_caster_animation_name_.present ())
    {
      throw ::xsd::cxx::tree::expected_attribute< wchar_t > (
        L"combo_2_caster_animation_name",
        L"");
    }

    if (!combo_2_caster_effect_.present ())
    {
      throw ::xsd::cxx::tree::expected_attribute< wchar_t > (
        L"combo_2_caster_effect",
        L"");
    }

    if (!combo_2_castee_animation_name_.present ())
    {
      throw ::xsd::cxx::tree::expected_attribute< wchar_t > (
        L"combo_2_castee_animation_name",
        L"");
    }

    if (!combo_2_castee_effect_.present ())
    {
      throw ::xsd::cxx::tree::expected_attribute< wchar_t > (
        L"combo_2_castee_effect",
        L"");
    }

    if (!combo_2_castee_interval_time_.present ())
    {
      throw ::xsd::cxx::tree::expected_attribute< wchar_t > (
        L"combo_2_castee_interval_time",
        L"");
    }

    if (!combo_3_caster_animation_name_.present ())
    {
      throw ::xsd::cxx::tree::expected_attribute< wchar_t > (
        L"combo_3_caster_animation_name",
        L"");
    }

    if (!combo_3_caster_effect_.present ())
    {
      throw ::xsd::cxx::tree::expected_attribute< wchar_t > (
        L"combo_3_caster_effect",
        L"");
    }

    if (!combo_3_castee_animation_name_.present ())
    {
      throw ::xsd::cxx::tree::expected_attribute< wchar_t > (
        L"combo_3_castee_animation_name",
        L"");
    }

    if (!combo_3_castee_effect_.present ())
    {
      throw ::xsd::cxx::tree::expected_attribute< wchar_t > (
        L"combo_3_castee_effect",
        L"");
    }

    if (!combo_3_castee_interval_time_.present ())
    {
      throw ::xsd::cxx::tree::expected_attribute< wchar_t > (
        L"combo_3_castee_interval_time",
        L"");
    }
  }

  player_active_skill_t* player_active_skill_t::
  _clone (::xml_schema::flags f,
          ::xml_schema::container* c) const
  {
    return new class player_active_skill_t (*this, f, c);
  }
  ...
  operator= (const player_active_skill_t& x)
  {
    if (this != &x)
    {
      ...
      this->need_skill_point_ = x.need_skill_point_;
      this->learn_character_class_ = x.learn_character_class_;
      this->need_learn_skill_code_1_ = x.need_learn_skill_code_1_;
      this->need_learn_skill_code_2_ = x.need_learn_skill_code_2_;
      this->next_skill_code_1_ = x.next_skill_code_1_;
      this->next_skill_code_2_ = x.next_skill_code_2_;
      this->check_equip_part_ = x.check_equip_part_;
      this->check_castable_equip_type_ = x.check_castable_equip_type_;
      this->skill_type_ = x.skill_type_;
      this->usable_state_ = x.usable_state_;
      this->transition_state_ = x.transition_state_;
      this->consumed_hp_ = x.consumed_hp_;
      this->consumed_mp_ = x.consumed_mp_;
      this->check_mez_type_ = x.check_mez_type_;
      this->check_point_target_type_ = x.check_point_target_type_;
      this->check_point_type_ = x.check_point_type_;
      this->check_point_up_down_ = x.check_point_up_down_;
      this->check_point_value_by_percent_ = x.check_point_value_by_percent_;
      this->check_point_value_ = x.check_point_value_;
      ...
      this->channel_casting_time_ = x.channel_casting_time_;
      this->channel_tick_ = x.channel_tick_;
      this->consume_item_code_ = x.consume_item_code_;
      this->consume_item_count_ = x.consume_item_count_;
      ...
      this->combo_1_caster_animation_name_ = x.combo_1_caster_animation_name_;
      this->combo_1_caster_effect_ = x.combo_1_caster_effect_;
      this->combo_1_castee_animation_name_ = x.combo_1_castee_animation_name_;
      this->combo_1_castee_effect_ = x.combo_1_castee_effect_;
      this->combo_1_castee_interval_time_ = x.combo_1_castee_interval_time_;
      this->combo_2_caster_animation_name_ = x.combo_2_caster_animation_name_;
      this->combo_2_caster_effect_ = x.combo_2_caster_effect_;
      this->combo_2_castee_animation_name_ = x.combo_2_castee_animation_name_;
      this->combo_2_castee_effect_ = x.combo_2_castee_effect_;
      this->combo_2_castee_interval_time_ = x.combo_2_castee_interval_time_;
      this->combo_3_caster_animation_name_ = x.combo_3_caster_animation_name_;
      this->combo_3_caster_effect_ = x.combo_3_caster_effect_;
      this->combo_3_castee_animation_name_ = x.combo_3_castee_animation_name_;
      this->combo_3_castee_effect_ = x.combo_3_castee_effect_;
      this->combo_3_castee_interval_time_ = x.combo_3_castee_interval_time_;
    }
  ...
  player_active_skill_table ()
  : ::xml_schema::type (),
    player_active_skill_template_ (this)
  {
  }
  ...
  player_active_skill_table (const player_active_skill_table& x,
                             ...
                             ::xml_schema::container* c)
  : ::xml_schema::type (x, f, c),
    player_active_skill_template_ (x.player_active_skill_template_, f, this)
  {
  }
  ...
  void player_active_skill_table::
  parse (::xsd::cxx::xml::dom::parser< wchar_t >& p,
         ::xml_schema::flags f)
  {
    for (; p.more_content (); p.next_content (false))
    {
      ...
      //
      if (n.name () == L"player_active_skill_template" && n.namespace_ ().empty ())
      {
        ::std::unique_ptr< player_active_skill_template_type > r (
          player_active_skill_template_traits::create (i, f, this));

        this->player_active_skill_template_.push_back (::std::move (r));
        continue;
      }
  ...
  player_active_skill_table* player_active_skill_table::
  _clone (::xml_schema::flags f,
          ::xml_schema::container* c) const
  {
    return new class player_active_skill_table (*this, f, c);
  }
  ...
  operator= (const player_active_skill_table& x)
  {
    ...
    {
      static_cast< ::xml_schema::type& > (*this) = x;
      this->player_active_skill_template_ = x.player_active_skill_template_;
    }
...
namespace gdt
{
  ...
  player_active_skill_table_ (const ::std::wstring& u,
                              ::xml_schema::flags f,
                              const ::xml_schema::properties& p)
  {
    ...
    return ::std::unique_ptr< ::gdt::player_active_skill_table > (
      ::gdt::player_active_skill_table_ (
                              ...
                              const ::xml_schema::properties& p)
  {
    ...
    return ::gdt::player_active_skill_table_ (isrc, f, p);
  }
                              ...
                              const ::xml_schema::properties& p)
  {
    ...
    ::xsd::cxx::xml::sax::std_input_source isrc (is);
    return ::gdt::player_active_skill_table_ (isrc, h, f, p);
  }
  ...
  ::std::unique_ptr< ::gdt::player_active_skill_table >
  player_active_skill_table_ (::xercesc::InputSource& i,
                              ::xml_schema::flags f,
                              const ::xml_schema::properties& p)
  {
    ::xsd::cxx::tree::error_handler< wchar_t > h;
  ...
  ::std::unique_ptr< ::gdt::player_active_skill_table >
  player_active_skill_table_ (const ::xercesc::DOMDocument& doc,
                              ::xml_schema::flags f,
                              const ::xml_schema::properties& p)
  {
    ...
    if (n.name () == L"player_active_skill_table" &&
        n.namespace_ () == L"")
    {
      ::std::unique_ptr< ::gdt::player_active_skill_table > r (
        ::xsd::cxx::tree::traits< ::gdt::player_active_skill_table, wchar_t >::create (
          e, f, 0));
      return r;
    }
...
{
  void
  player_active_skill_table_ (::std::ostream& o,
                              const ::gdt::player_active_skill_table& s,
                              ...
                              ::xml_schema::flags f)
  {
    ...
    ::xml_schema::dom::unique_ptr< ::xercesc::DOMDocument > d (
      ::gdt::player_active_skill_table_ (s, m, f));
  ...
  void
  player_active_skill_table_ (::xercesc::XMLFormatTarget& t,
                              const ::gdt::player_active_skill_table& s,
                              const ::xml_schema::namespace_infomap& m,
                              const ::std::wstring& e,
                              ::xml_schema::flags f)
  ...
  player_active_skill_table_ (const ::gdt::player_active_skill_table& s,
                              const ::xml_schema::namespace_infomap& m,
                              ::xml_schema::flags f)
  {
    ::xml_schema::dom::unique_ptr< ::xercesc::DOMDocument > d (
    ...
    ::gdt::player_active_skill_table_ (*d, s, f);
    return d;
  }

  void
  operator<< (::xercesc::DOMElement& e, const player_active_skill_t& i)
  {
    ...
    //
    {
      ::xercesc::DOMAttr& a (
        ::xsd::cxx::xml::dom::create_attribute (
          L"need_learn_skill_code_1",
          e));

      a << i.need_learn_skill_code_1 ();
    }
    ...
    //
    {
      ::xercesc::DOMAttr& a (
        ::xsd::cxx::xml::dom::create_attribute (
          L"need_learn_skill_code_2",
          e));

      a << i.need_learn_skill_code_2 ();
    }
    ...
    //
    {
      ...
      a << i.check_point_value_by_percent ();
    }
    ...
    //
    {
      ...
      a << i.combo_1_caster_animation_name ();
    }
    ...
    //
    {
      ...
      a << i.combo_1_castee_animation_name ();
    }
    ...
    //
    {
      ...
      a << i.combo_1_castee_interval_time ();
    }
    ...
    //
    {
      ...
      a << i.combo_2_caster_animation_name ();
    }
    ...
    //
    {
      ...
      a << i.combo_2_castee_animation_name ();
    }
    ...
    //
    {
      ...
      a << i.combo_2_castee_interval_time ();
    }
    ...
    //
    {
      ...
      a << i.combo_3_caster_animation_name ();
    }
    ...
    //
    {
      ...
      a << i.combo_3_castee_animation_name ();
    }
    ...
    //
    {
      ...
      a << i.combo_3_castee_interval_time ();
    }
  }

  void
  operator<< (::xercesc::DOMElement& e, const player_active_skill_table& i)
  {
    e << static_cast< const ::xml_schema::type& > (i);

    // player_active_skill_template
    //
    for (player_active_skill_table::player_active_skill_template_const_iterator
         b (i.player_active_skill_template ().begin ()), n (i.player_active_skill_template ().end ());
         b != n; ++b)
    {
      ::xercesc::DOMElement& s (
        ::xsd::cxx::xml::dom::create_element (
          L"player_active_skill_template",
          e));
